...
if __name__ == '__main__':
    ...
    for sig_1 in sigs_by_mu_1:
        ...
        W1_1_vars_1 = np.random.normal(loc=mu_1, scale=sig_1*mu_1, size=(Wt_bits, 96, in_ch, 3, 3))
        W1_2_vars_1 = np.random.normal(loc=mu_1, scale=sig_1*mu_1, size=(Wt_bits, 96, 96, 3, 3))
        W1_3_vars_1 = np.random.normal(loc=mu_1, scale=sig_1*mu_1, size=(Wt_bits, 96, 96, 3, 3))

        W2_1_vars_1 = np.random.normal(loc=mu_1, scale=sig_1*mu_1, size=(Wt_bits, 192, 96, 3, 3))
        W2_2_vars_1 = np.random.normal(loc=mu_1, scale=sig_1*mu_1, size=(Wt_bits, 192, 192, 3, 3))
        W2_3_vars_1 = np.random.normal(loc=mu_1, scale=sig_1*mu_1, size=(Wt_bits, 192, 192, 3, 3))

        W3_1_vars_1 = np.random.normal(loc=mu_1, scale=sig_1*mu_1, size=(Wt_bits, 192, 192, 3, 3))
        W3_2_vars_1 = np.random.normal(loc=mu_1, scale=sig_1*mu_1, size=(Wt_bits, 192, 192, 1, 1))
        W3_3_vars_1 = np.random.normal(loc=mu_1, scale=sig_1*mu_1, size=(Wt_bits, out_sz, 192, 1, 1))
        ...
        for epoch in range(num_epochs):
            ...
            if (epoch%50 == 49) or (epoch>num_epochs-5):
                ...
                #print("ON bit sigma by mu: ", sig_1)
    ...
    savemat(save_folder + "CIFAR100_training_quant_aware_" + str(Wt_bits) + "bit.mat", sv_dict)
